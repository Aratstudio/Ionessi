...
if ($isFilter || $isSidebar): ?>
	...
	<div class="col-xl-3 col-lg-4 d-none d-lg-block<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
...
<div class="<?=(($isFilter || $isSidebar) ? "col-xl-9 col-lg-8" : "col-xs-12")?>">
...
<div class="catalog-items">
		<div class="row-items"> 
			<!-- это вверхний список категорий. Там еще h1 торчит -->
			<?
